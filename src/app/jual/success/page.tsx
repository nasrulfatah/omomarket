...
export default function SuccessPage() {
  const whatsappLink = "https://wa.me/6289611117575?text=Halo%20Omomarket%2C%20saya%20baru%20saja%20melisting%20PO%20omo%20saya%20di%20Omomarket.%20Mohon%20segera%20diverifikasi%20dan%20di-listing%20ya.%20Terima%20kasih!";
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6">
      <div className="text-center">
        ...
        <h1 className="text-3xl font-bold">Listing Anda Berhasil Tersimpan!</h1>
        <p className="mt-4 text-lg text-black/70">
          Terimakasih sudah melisting PO Anda di Omomarket. Tim kami akan memverifikasi
          dan melisting PO Anda sesegera mungkin.
        </p>

        <div className="mt-8 space-y-3">
          <p className="text-sm text-black/60">
            Jika ingin mempercepat verifikasi, Anda bisa menghubungi admin kami melalui WhatsApp:
          </p>
      ...
      <div className="mt-16 rounded-2xl border border-line bg-neutral-50 p-8">
        ...
        <ul className="mt-4 space-y-3 text-sm text-black/70">
          <li className="flex gap-3">
            ...
            <span>Tim Omomarket akan memverifikasi data dan foto PO Anda</span>
          </li>
          <li className="flex gap-3">
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-accent text-xs font-bold text-black">
              2
            </span>
            <span>Listing Anda akan ditampilkan di katalog untuk calon pembeli</span>
          </li>
          <li className="flex gap-3">
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-accent text-xs font-bold text-black">
              3
            ...
            <span>
              Calon pembeli akan menghubungi Omomarket, dan kami akan menghubungkan kalian
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-accent text-xs font-bold text-black">
            ...
            <span>Proses transaksi diserahkan kepada Anda dan pembeli</span>
          </li>
        </ul>
      </div>
    </div>

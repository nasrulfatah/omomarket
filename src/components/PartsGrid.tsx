    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-line bg-neutral-50 p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-end">
          {/* Category Dropdown */}
          <div>
            <label className="block text-xs font-semibold text-black/60 mb-2 uppercase tracking-wide">
              Kategori
            </label>
            <select
              value={selectedCategory}
              onChange={(e) => setSelectedCategory(e.target.value as PartCategory | "all")}
              className="w-full px-3 py-2 rounded-lg border border-line bg-white text-black text-sm font-medium cursor-pointer hover:border-black/30 transition"
            >
          ...
          <div className="space-y-2">
            <label className="block text-xs font-semibold text-black/60 uppercase tracking-wide">
              Harga Max
            </label>
            <div className="flex gap-3 items-end">
              ...
              <div className="text-right shrink-0">
                <p className="text-sm font-bold text-black whitespace-nowrap">{formatRupiah(maxPrice)}</p>
